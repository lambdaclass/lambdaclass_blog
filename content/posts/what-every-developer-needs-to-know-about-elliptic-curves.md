...
[extra]
feature_image = "/content/images/2025/12/Jose--_Moreno_Carbonero_-_Fundacio--n_de_Buenos_Aires.jpg"
authors = ["LambdaClass"]
...
![](/content/images/2022/12/imagen-5.png)

It takes a little bit of work, but we can prove that the elliptic curve with this operation has the properties of a group. We will use finite fields to work with these curves and the groups that we will obtain are finite cyclic groups, that is, groups which can be generated by repeteadly using the operation on a generator, _g: g,2g,3g,4g,5g,...._ ![](/content/images/2022/12/imagen-3.png)
