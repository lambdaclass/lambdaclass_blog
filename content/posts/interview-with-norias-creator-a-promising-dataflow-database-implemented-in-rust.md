+++
title = "Interview with Noria’s creator: a promising dataflow research database implemented in Rust"
date = 2019-10-22
slug = "interview-with-norias-creator-a-promising-dataflow-database-implemented-in-rust"
...
[taxonomies]
tags = ["Rust", "Big Data", "Distributed Systems"]
+++
...
(<https://pdos.csail.mit.edu/6.824/schedule.html>). It covers both classic  
